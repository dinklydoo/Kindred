...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // fields
      char dummy21[sizeof (std::vector<Field>)];

      // opt_params
      // params
      char dummy22[sizeof (std::vector<Param>)];

      // patterns
      char dummy23[sizeof (std::vector<c_branch_ptr>)];

      // definitions
      // helpers
      char dummy24[sizeof (std::vector<decl_ptr>)];

      // expr_list
      char dummy25[sizeof (std::vector<expr_ptr>)];

      // guards
      char dummy26[sizeof (std::vector<g_branch_ptr>)];
      ...
      // opt_types
      // types
      char dummy28[sizeof (std::vector<type_ptr>)];

      // struct_def
      char dummy29[sizeof (struct_decl_ptr)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_assign_val_expr = 112,                 // assign_val_expr
